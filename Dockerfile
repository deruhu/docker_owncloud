...
ADD https://download.owncloud.org/community/owncloud-8.1.0.tar.bz2 /tmp/oc.tar.bz2
ADD https://download.owncloud.org/community/owncloud-8.1.0.tar.bz2.asc /tmp/oc.tar.bz2.asc
